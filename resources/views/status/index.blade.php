        ...
        <div class="col">
          ...
          <div class="card pl-3 pr-3 pb-3">
            ...
            <div class="table-responsive">
              <table id="statuss" class="table table-stripped align-items-center table-flush p-10" style="width:100%">
                ...
                <tbody class="list">
                  ...
                  <tr>
                      <td class="id">
                        <div class="media-body">{{$status->id}}</div>
                      </td>
                    <th scope="row">
                      <div class="media align-items-center">
                        <div class="media-body">
                          <span class="name mb-0 text-sm">{{$status->name}}</span>
                        </div>
                      </div>
                    </th>
                    <td class="text-right">
                        <a class="btn btn-sm btn-icon-only" style="color: #f48e5f;" data-toggle="modal" data-target="#Edit{{$status->id}}">
                  ...
                  <!-- Edit Modal -->
  <div class="float modal fade" id="Edit{{$status->id}}" tabindex="-1" aria-labelledby="Edit{{$status->id}}Label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="Edit{{$status->id}}Label">Add</h5>
        ...
        <div class="modal-body">
            <form method="POST" action="{{route('status.update',$status->id)}}">
                ...
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control col-sm-9" id="name" name="name" placeholder="Masukan Nama status, contoh: Pending, Succsess" value="{{$status->name}}" required autofocus>
                </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{route('status.create')}}">
                ...
                <div class="form-group row">
                  <label for="name" class="col-sm-2 col-form-label">Nama</label>
                  <input type="text" class="form-control col-sm-9" id="name" name="name" placeholder="Masukan Nama status, contoh: Pending, Success" required autofocus>
