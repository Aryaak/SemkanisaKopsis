        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <button type="button" class="btn btn-sm p-2 btn-warning" data-toggle="modal" data-target="#addNew" title="Create New payment">Tambah Baru</button>
        ...
        <div class="col">
          ...
          <div class="card pl-3 pr-3 pb-3">
            ...
            <div class="table-responsive">
              <table id="payments" class="table table-stripped align-items-center table-flush p-10" style="width:100%">
                ...
                <tbody class="list">
                  ...
                  <tr>
                      <td class="id">
                        <div class="media-body">{{$payment->id}}</div>
                      </td>
                    <th scope="row">
                      <div class="media align-items-center">
                        <div class="media-body">
                          <span class="name mb-0 text-sm">{{$payment->name}}</span>
                        </div>
                      </div>
                    </th>
                    <td class="text-right">
                  ...
                  <!-- Edit Modal -->
  <div class="float modal fade" id="Edit{{$payment->id}}" tabindex="-1" aria-labelledby="Edit{{$payment->id}}Label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="Edit{{$payment->id}}Label">Add</h5>
        ...
        <div class="modal-body">
            <form method="POST" action="{{route('payment.update',$payment->id)}}">
                ...
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control col-sm-9" id="name" name="name" placeholder="Masukan Nama Pembayaran, contoh: Kredit, Debit" value="{{$payment->name}}" required autofocus>
                </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{route('payment.create')}}">
                ...
                <div class="form-group row">
                  <label for="name" class="col-sm-2 col-form-label">Nama</label>
                  <input type="text" class="form-control col-sm-9" id="name" name="name" placeholder="Masukan Nama Pembayaran, contoh: Kredit, Debit" required autofocus>
